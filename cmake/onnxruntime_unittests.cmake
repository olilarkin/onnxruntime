    ...
    if (onnxruntime_BUILD_WEBASSEMBLY)
      ...
      if (onnxruntime_WEBASSEMBLY_RUN_TESTS_IN_BROWSER)
        ...
        add_test(NAME ${_UT_TARGET}
          COMMAND ${NPM_CLI} test ${TEST_NODE_FLAGS} -- --entry=${_UT_TARGET}.js ${TEST_ARGS}
          WORKING_DIRECTORY $<TARGET_FILE_DIR:${_UT_TARGET}>
        )
      else()
        set(TEST_NODE_FLAGS)
...
if (onnxruntime_BUILD_WEBASSEMBLY)
  ...
  set_target_properties(onnxruntime_test_all PROPERTIES LINK_FLAGS "-s SAFE_HEAP=1 -s ALLOW_MEMORY_GROWTH=1 --pre-js \"${TEST_SRC_DIR}/wasm/onnxruntime_test_all_adapter.js\" -s \"EXPORTED_RUNTIME_METHODS=['FS']\" --preload-file ${CMAKE_CURRENT_BINARY_DIR}/testdata@/testdata -s EXIT_RUNTIME=1")
  if (onnxruntime_ENABLE_WEBASSEMBLY_THREADS)
